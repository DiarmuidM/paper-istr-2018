...
datapath = 'C:/Users/mcdonndz-local/Dropbox/paper-istr-2018/data_raw/' # Dropbox folder for raw data

# Specify the source file for the deregistration reasons
inputfilepath = datapath + 'Organisations/' + 'nz_Organisations_y0_m0_p0_20180330.csv_integrity.csv'
